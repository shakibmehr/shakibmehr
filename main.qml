...
Window {
    ...
    onWidthChanged: {
        mapWidth = rootWindow.width
        mapHeight = rootWindow.height
    }
    ...
    Map {
        ...
        center: QtPositioning.coordinate(27.0483, 56.0695);
        zoomLevel: 6
        plugin: Plugin {
            id:  mapPlugin1
            name: "mapbox"
...
//                        console.log("legs : ",routeModel.get(0).legs)
            ...
            Button{
             ...
             //   onClicked: console.log("List: ",routeModel.travelTime)
               ...
               MapQuickItem {
                   coordinate: QtPositioning.coordinate(27.0483, 56.0695);

//                   anchorPoint.x: image.width * 0.5
//                   anchorPoint.y: image.height

                   sourceItem: Column {
                       Image { id: image; source: "qrc:/1.png"
